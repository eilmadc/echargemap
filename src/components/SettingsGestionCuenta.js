        ...
        <section className='settings-container'>
          <div className='setting-header' >
            <div className='setting-title'>
              <h2 id={id} className='settingtitle manage-account'>Gestión de la cuenta</h2>
            </div >
            <div className='setting-desc'>
              <h3 id={id} className='desc manage-account'>Modifica datos privados de tu cuenta</h3>
            </div>
          </div >
              ...
              <div className='manage-options'>
                      ...
                      <div className='nueva-contr-container'>
                        ...
                        <div className='formulario-contr'>
                          ...
                          <div className='wrap-antigua-contr'>
                            <label
                              className='antigua-contr' id={id}>Contraseña actual</label>
                            <input
                ...
                {show === 'borrar-cuenta' ?
                  <div className='borrar-cuenta-container'>
                    <div className='desc-borrar-cuenta' id={id}>Estás en proceso de borrar todos los datos de tu cuenta.</div>
                    <div className='nombre-usuario-logado' id={id} ><h4 >{stg.get('username')}</h4></div>
                    <div className='texto-borrar-cuenta' id={id}>si continúas, tu nombre, ubicación y correo electrónico así como tus comentarios y estaciones guardadas se eliminarán y no podrás volver a acceder a ellas.<br /><br />
